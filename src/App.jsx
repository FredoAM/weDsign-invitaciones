                    ...
                    <div className="row">
                      <div className="col-md-12">
                        <div className="form-group">
                          <input name="name" type="text" className="form-control" placeholder="Name" required /> </div>
                      </div>
                      <div className="col-md-12">
                        <div className="form-group">
                          <input name="email" type="email" className="form-control" placeholder="Email" required /> </div>
                      </div>
                      <div className="col-md-12">
                        <div className="form-group">
                          <input name="guests" type="text" className="form-control" placeholder="Guests" required /> </div>
                      </div>
                      <div className="col-md-12">
                        <div className="form-group">
                      ...
                      <div className="col-md-12">
                        <div className="form-group">
                          <input name="submit" type="submit" className="btn buttono" value="SEND" />
                        </div>
                      </div>
                    </div>
                  </form>
