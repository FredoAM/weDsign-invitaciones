...
function App() {
  ...
  return (
    ...
    <div className="preloader">
      ...
      <div id="oliven-main">
        <header id="home" className="header valign bg-img parallaxie " style={{backgroundImage: `url(/src/assets/images/slider.jpg)`}}>
            ...
            <div className="row mb-60">
              <div className="col-md-6">
                <div className="item toright mb-30 animate-box" data-animate-effect="fadeInLeft">
                  <div className="img"> <img src="/src/assets/images/bride.jpg" alt="" /> </div>
              ...
              <div className="col-md-6">
                <div className="item mb-30 animate-box" data-animate-effect="fadeInRight">
                  <div className="img"> <img src="/src/assets/images/groom.jpg" alt="" /> </div>
                  <div className="info valign">
                    <div className="full-width">
        ...
        <div id="countdown" className="section-padding bg-img bg-fixed" style={{backgroundImage: `url(/src/assets/images/banner-1.jpg)`}}>
          <div className="container">
            <div className="row">
            ...
            <div className="row">
              <div className="col-md-5 mb-30">
                <div className="story-img animate-box" data-animate-effect="fadeInLeft">
                  <div className="img"> <img src="/src/assets/images/story.jpg" className="img-fluid" alt="" /> </div>
                  <div className="story-img-2 story-wedding" style={{backgroundImage: 'url(/src/assets/images/wedding-logo.png)'}}></div>
                </div>
              </div>
            ...
            <div className="row">
              <div className="col-md-12">
                <div className="owl-carousel owl-theme">
                  <div className="item">
                    <div className="img"> <img src="/src/assets/images/friends/b1.jpg" alt="" /> </div>
                    <div className="info valign">
                      <div className="full-width">
                  ...
                  <div className="item">
                    <div className="img"> <img src="/src/assets/images/friends/w1.jpg" alt="" /> </div>
                    <div className="info valign">
                      <div className="full-width">
                  ...
                  <div className="item">
                    <div className="img"> <img src="/src/assets/images/friends/b2.jpg" alt="" /> </div>
                    <div className="info valign">
                      <div className="full-width">
                  ...
                  <div className="item">
                    <div className="img"> <img src="/src/assets/images/friends/w2.jpg" alt="" /> </div>
                    <div className="info valign">
                      <div className="full-width">
                  ...
                  <div className="item">
                    <div className="img"> <img src="/src/assets/images/friends/b3.jpg" alt="" /> </div>
                    <div className="info valign">
                      <div className="full-width">
                  ...
                  <div className="item">
                    <div className="img"> <img src="/src/assets/images/friends/w3.jpg" alt="" /> </div>
                    <div className="info valign">
                      <div className="full-width">
        ...
        <div id="seeyou" className="seeyou section-padding bg-img bg-fixed" style={{backgroundImage: `url(/src/assets/images/banner-3.jpg)`}}>
          <div className="container">
            <div className="row">
        ...
        <div id="organization" className="organization section-padding bg-pink">
          <div className="container">
            ...
            <div className="row bord-box bg-img" style={{backgroundImage: `url(/src/assets/images/slider.jpg)`}}>
            ...
            <div className="row gallery-filter mt-3">
              <div className="col-md-4 gallery-item ceremony">
                <a href="images/gallery/1.jpg" className="img-zoom">
                  <div className="gallery-box">
                    <div className="gallery-img"> <img src="/src/assets/images/gallery/1.jpg" className="img-fluid mx-auto d-block" alt="" /> </div>
              ...
              <div className="col-md-4 gallery-item party">
                <a href="images/gallery/2.jpg" className="img-zoom">
                  <div className="gallery-box">
                    <div className="gallery-img"> <img src="/src/assets/images/gallery/2.jpg" className="img-fluid mx-auto d-block" alt="" /> </div>
                    <div className="gallery-detail">
              ...
              <div className="col-md-4 gallery-item ceremony">
                <a href="images/gallery/3.jpg" className="img-zoom">
                  <div className="gallery-box">
                    <div className="gallery-img"> <img src="/src/assets/images/gallery/3.jpg" className="img-fluid mx-auto d-block" alt="" /> </div>
                    <div className="gallery-detail">
              ...
              <div className="col-md-4 gallery-item party">
                <a href="images/gallery/4.jpg" className="img-zoom">
                  <div className="gallery-box">
                    <div className="gallery-img"> <img src="/src/assets/images/gallery/4.jpg" className="img-fluid mx-auto d-block" alt="" /> </div>
                    <div className="gallery-detail">
                      <h4 className="mb-0">Wedding Party</h4> </div>
                  </div>
                </a>
              ...
              <div className="col-md-4 gallery-item ceremony">
                <a href="images/gallery/5.jpg" className="img-zoom">
                  <div className="gallery-box">
                    <div className="gallery-img"> <img src="/src/assets/images/gallery/5.jpg" className="img-fluid mx-auto d-block" alt="" /> </div>
                    <div className="gallery-detail">
                      <h4 className="mb-0">Wedding Ceremony</h4> </div>
                  </div>
                </a>
              ...
              <div className="col-md-4 gallery-item party">
                <a href="images/gallery/6.jpg" className="img-zoom">
                  <div className="gallery-box">
                    <div className="gallery-img"> <img src="/src/assets/images/gallery/6.jpg" className="img-fluid mx-auto d-block" alt="" /> </div>
                    <div className="gallery-detail">
                      <h4 className="mb-0">Wedding Party</h4> </div>
                  </div>
                </a>
          ...
          <div className="container">
            ...
            <div className="row">
              <div className="col-md-12">
                <div className="owl-carousel owl-theme">
                  <div className="item">
                    <div className="whenwhere-img"> <img src="/src/assets/images/whenwhere/3.jpg" alt="" /></div>
                  ...
                  <div className="item">
                    <div className="whenwhere-img"> <img src="/src/assets/images/whenwhere/1.jpg" alt="" /></div>
                    <div className="content">
                  ...
                  <div className="item">
                    <div className="whenwhere-img"> <img src="/src/assets/images/whenwhere/2.jpg" alt="" /></div>
                    <div className="content">
                      <h5>Accomodations</h5>
        ...
        {/* <div id="rsvp" className="section-padding bg-img bg-fixed" style={{backgroundImage: `url(/src/assets/images/banner-2.jpg)`}}>
          <div className="container">
            <div className="row">
              ...
              <div className="col-md-9">
                <div className="owl-carousel">
                  <div className="client-logo">
                    <a href="#"><img src="/src/assets/images/gift/1.jpg" alt="" /></a>
                  </div>
                  <div className="client-logo">
                    <a href="#"><img src="/src/assets/images/gift/2.jpg" alt="" /></a>
                  </div>
                  <div className="client-logo">
                    <a href="#"><img src="/src/assets/images/gift/3.jpg" alt="" /></a>
                  </div>
                  <div className="client-logo">
                    <a href="#"><img src="/src/assets/images/gift/4.jpg" alt="" /></a>
                  </div>
                  <div className="client-logo">
                    <a href="#"><img src="/src/assets/images/gift/5.jpg" alt="" /></a>
                  </div>
                  <div className="client-logo">
                    <a href="#"><img src="/src/assets/images/gift/6.jpg" alt="" /></a>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="oliven-narrow-content">
            <div className="row">
              <div className="col-md-12 text-center">
                <h2>
                  <a href="index.html"><img src="/src/assets/images/logo.png" alt="" /><span>Olivia <small>&</small> Brandon</span></a>
                </h2>
